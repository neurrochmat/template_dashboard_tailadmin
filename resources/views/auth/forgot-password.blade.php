...
<head>
  ...
  <title>Forgot Password | TailAdmin</title>
  ...
  <div class="relative flex min-h-screen items-center justify-center px-4 py-10">
    ...
    <div class="relative z-10 mx-auto w-full max-w-md">
      <div class="mb-6 text-center text-white">
        ...
        <p class="text-white/80 text-sm">We will email you a password reset link</p>
      </div>
      ...
      <div class="rounded-2xl bg-white/95 p-6 shadow-2xl ring-1 ring-white/10 backdrop-blur-md dark:bg-gray-900/95">
        ...
        <form action="{{ route('password.email') }}" method="POST" class="space-y-4">
          ...
          <button type="submit" class="inline-flex w-full items-center justify-center rounded-lg bg-indigo-600 px-6 py-3 font-semibold text-white shadow-lg transition hover:bg-indigo-700">Email reset link</button>
        </form>
